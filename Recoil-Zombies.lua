...
for i, v in pairs(weaponsStorage:GetChildren()) do
    ...
    if Variables:FindFirstChild('ClipSize') then
        Variables.ClipSize.Value = 999
    end

    if Variables:FindFirstChild('Ammo') then
        Variables.Ammo.Value = 999
    end
